...
# paviaATN
uv run python notebooks/evaluate_notebook.py --ckpt_dir=/group/jug/ashesh/training/denoisplit/2503/D3-M3-S0-L0/1 --override_kwargs='{"MIXING_WEIGHT":0.5, "k_forward_pass":2, "data_dir":"/group/jug/ashesh/data/microscopy"}'
uv run python notebooks/evaluate_notebook.py --ckpt_dir=/group/jug/ashesh/training/denoisplit/2503/D3-M3-S0-L0/1 --override_kwargs='{"MIXING_WEIGHT":0.5, "k_forward_pass":1, "data_dir":"/group/jug/ashesh/data/microscopy"}'
